...
## AI
- Ask a question and confirm it responds.
- Confirm it references your components/wiring/journal (and small code snippets if uploaded).

## Backup
- Go to `/backup` and download a JSON export.
